...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dist/css/image-uploader.min.css') }}">
</head>
<br>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/indexx') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/indexxxx')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/indexxx')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/indexi')}}" class="nav-link">
                                <i class="nav-icon fas fa-users"></i>
                                <p>
                                    slider manager
                                </p>
